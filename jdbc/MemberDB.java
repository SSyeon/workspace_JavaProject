...
conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/javap", "root","mirim2"); // JDBC 연결
...
textName.setText(viewRS.getString("name"));  
textPass.setText(viewRS.getString("pass"));  
textNum1.setText(viewRS.getString("Num1"));  
textNum2.setText(viewRS.getString("Num2"));  
textPhone.setText(viewRS.getString("Phone"));   
}
